...
public abstract class FilterOptions {
     ...
     */
    public final static String[] languages = {"All","English", "Arabic", "Bulgarian", "Catalan", "Chinese", "Croatian",
     ...
     * The items in this array have to be in the same order as in strings.xml and the values must match with the corresponding string array
     */
    public final static String[] categories = {"All", "Economy", "Environment", "Fashion", "Food", "Fun", "Health", "Miscellaneous",
