...
public class PollBeanApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
   ...
   * @return the request
   */
  public GetRandomPollBeans getRandomPollBeans(java.lang.Integer category, java.lang.Integer language) throws java.io.IOException {
  ...
  public class GetRandomPollBeans extends PollBeanApiRequest<model.pollBeanApi.model.PollBeanCollection> {
     ...
     * @since 1.13
     */
    protected GetRandomPollBeans(java.lang.Integer category, java.lang.Integer language) {
      super(PollBeanApi.this, "GET", REST_PATH, null, model.pollBeanApi.model.PollBeanCollection.class);
    ...
    public GetRandomPollBeans setCategory(java.lang.Integer category) {
    ...
    public GetRandomPollBeans setLanguage(java.lang.Integer language) {
  ...
  /**
   * Create a request for the method "getRecentlyVotedPollBeans".
   *
   * This request holds the parameters needed by the pollBeanApi server.  After setting any optional
   * parameters, call the {@link GetRecentlyVotedPollBeans#execute()} method to invoke the remote
   * operation.
   *
   * @param ids
   * @return the request
   */
  public GetRecentlyVotedPollBeans getRecentlyVotedPollBeans(java.util.List<java.lang.Long> ids) throws java.io.IOException {
    GetRecentlyVotedPollBeans result = new GetRecentlyVotedPollBeans(ids);
    initialize(result);
    return result;
  }

  public class GetRecentlyVotedPollBeans extends PollBeanApiRequest<model.pollBeanApi.model.JsonMap> {

    private static final String REST_PATH = "getRecentPolls";

    /**
     * Create a request for the method "getRecentlyVotedPollBeans".
     *
     * This request holds the parameters needed by the the pollBeanApi server.  After setting any
     * optional parameters, call the {@link GetRecentlyVotedPollBeans#execute()} method to invoke the
     * remote operation. <p> {@link GetRecentlyVotedPollBeans#initialize(com.google.api.client.googlea
     ...
     * @since 1.13
     */
    protected GetRecentlyVotedPollBeans(java.util.List<java.lang.Long> ids) {
      super(PollBeanApi.this, "GET", REST_PATH, null, model.pollBeanApi.model.JsonMap.class);
    ...
    @Override
    public GetRecentlyVotedPollBeans setAlt(java.lang.String alt) {
      return (GetRecentlyVotedPollBeans) super.setAlt(alt);
    }

    @Override
    public GetRecentlyVotedPollBeans setFields(java.lang.String fields) {
      return (GetRecentlyVotedPollBeans) super.setFields(fields);
    }

    @Override
    public GetRecentlyVotedPollBeans setKey(java.lang.String key) {
      return (GetRecentlyVotedPollBeans) super.setKey(key);
    }

    @Override
    public GetRecentlyVotedPollBeans setOauthToken(java.lang.String oauthToken) {
      return (GetRecentlyVotedPollBeans) super.setOauthToken(oauthToken);
    }

    @Override
    public GetRecentlyVotedPollBeans setPrettyPrint(java.lang.Boolean prettyPrint) {
      return (GetRecentlyVotedPollBeans) super.setPrettyPrint(prettyPrint);
    }

    @Override
    public GetRecentlyVotedPollBeans setQuotaUser(java.lang.String quotaUser) {
      return (GetRecentlyVotedPollBeans) super.setQuotaUser(quotaUser);
    }

    @Override
    public GetRecentlyVotedPollBeans setUserIp(java.lang.String userIp) {
      return (GetRecentlyVotedPollBeans) super.setUserIp(userIp);
    }
    ...
    public GetRecentlyVotedPollBeans setIds(java.util.List<java.lang.Long> ids) {
      this.ids = ids;
      return this;
    }

    @Override
    public GetRecentlyVotedPollBeans set(String parameterName, Object value) {
      return (GetRecentlyVotedPollBeans) super.set(parameterName, value);
    }
  }
