...
public class PollBeanApi extends com.google.api.client.googleapis.services.json.AbstractGoogleJsonClient {
  ...
  public class GetPollBean extends PollBeanApiRequest<model.pollBeanApi.model.PollBean> {
    ...
    private static final String REST_PATH = "pollbean/{id}";
   ...
   * @return the request
   */
  public UpdatePollBean updatePollBean() throws java.io.IOException {
    UpdatePollBean result = new UpdatePollBean();
    initialize(result);
    return result;
  }
  ...
  public class UpdatePollBean extends PollBeanApiRequest<Void> {
     ...
     * @since 1.13
     */
    protected UpdatePollBean() {
      super(PollBeanApi.this, "PUT", REST_PATH, null, Void.class);
    }
